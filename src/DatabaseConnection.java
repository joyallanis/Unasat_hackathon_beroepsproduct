...
public class DatabaseConnection {
    private static final String URL = "jdbc:mysql://localhost:3306/database_name";  // Declare a private static final variable named URL that contains the URL to connect to the database.
